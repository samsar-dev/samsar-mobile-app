                    ...
                    children: [
                      ...
                      AnimatedInputWrapper(
                        ...
                        child: DetailSectionCard(
                          title: "Colors",
                          items: [
                            IconLabelPair(Icons.directions_car_filled, "Exterior color: ${listing.details?.vehicles?.color}"),
                            IconLabelPair(Icons.event_seat, "Interior color: ${listing.details?.vehicles?.interiorColor}")
                          ],
                        ),
                      ),
                      ...
                      AnimatedInputWrapper(
                        ...
                        child: DetailSectionCard(
                          ...
                          items: [
                            ...
                            IconLabelPair(Icons.rotate_right, "${listing.details?.vehicles?.torque} NM"),
                            IconLabelPair(Icons.memory, "${listing.details?.vehicles?.engineSize} CC"),
                            IconLabelPair(Icons.confirmation_number, listing.details?.vehicles?.engineNumber ?? "NA"),
                          ],
                        ),
                      ),
