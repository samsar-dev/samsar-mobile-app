      ...
      child: Column(
        ...
        children: [
          ...
          AnimatedInputWrapper(
            ...
            child: switchInput("Emergency Braking Assist", isEmergencyBraking, (val) {
          ...
          AnimatedInputWrapper(
            ...
            child: switchInput("Parking Sensors (Front & Rear)", isParkingSensor, (val) {
      ...
      child: Column(
        ...
        children: [
          SwitchListTile(
            ...
            onChanged: (value) {
              setState(() {
                airbagsEnabled = value;
                if (!value) airbagsCountController.clear();
              });
            },
          ),
          if (airbagsEnabled)
