...
class _AdvanceListingOptionsState extends State<AdvanceListingOptions> {
          ...
          onStepContinue: () {
            if (currentStep < 4) {
              ...
              _listingInputController.setAdvanceDetails(
                ...
                previousOwners: previousOwnersController.text,
                condition: conditionController.text,
                importStatus: importStatusController.text,
                registrationExpiry: registerationController.text,
                interiorColor: '#${interiorColor.value.toRadixString(16).padLeft(8, '0').substring(2).toUpperCase()}',
                exteriorColor: '#${exteriorColor.value.toRadixString(16).padLeft(8, '0').substring(2).toUpperCase()}',
              );
        ...
        child: Column(
          children: [
            ...
            AnimatedInputWrapper(
              ...
              child: BuildInput(
                title: "Torque(NM)", 
                label: "Enter torque of your vehicle", 
                textController: torqueController
              )
            ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          AnimatedInputWrapper(
            delayMilliseconds: 0,
            child: buildColorInput("Exterior color", exteriorColor)
          ),
                
          SizedBox(height: screenHeight * 0.02),
          AnimatedInputWrapper(
            delayMilliseconds: 100,
            child: buildColorInput("Build interior color", interiorColor)
          ),
        ],
      ),
    );
  ...
  Widget buildColorInput(String title, Color selectedColor) {
    return Column(
      children: [
